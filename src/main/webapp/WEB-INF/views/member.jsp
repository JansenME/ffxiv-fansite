    ...
    <div id="content">
        <div>
            <table style="width:100%;">
                <tr>
                    <td style='padding:5px; text-align:right; width:20%;'><img
                            src="http://services.runescape.com/m=avatar-rs/${memberName}/chat.png"/></td>
                    <td style='padding:5px; text-align:center; width:60%;'><h3>${memberName}</h3></td>
                    <td style='padding:5px; text-align:left; width:20%;'><img
                            src="http://services.runescape.com/m=avatar-rs/${memberName}/full.png"/></td>
                </tr>
            </table>
                ...
                <table style='width:100%;'>
                    <tr>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td style='padding:5px; text-align:right;'><strong>Gender: </strong></td>
                                    <td style='padding:5px;'>${tableInfo.gender}</td>
                                </tr>
                                <tr>
                                    <td style='padding:5px; text-align:right;'><strong>Date of Birth: </strong></td>
                                    <td style='padding:5px;'>${tableInfo.dob}</td>
                                </tr>
                                <tr>
                                    <td style='padding:5px; text-align:right;'><strong>City: </strong></td>
                                    <td style='padding:5px;'>${tableInfo.cityStateCountry}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <div id="popupAdventurersLog" style="display: none; margin:auto;">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="listValue" items="${listAdventurersLog}">
                        <tr>
                            <td><p style='font-weight:bold;'>${listValue.formattedDate}
                                - ${listValue.title}</p>${listValue.description}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
