            ...
            <form:form method="POST" modelAttribute="itemsForm" class="form-signin">
                ...
                <spring:bind path="runescapeId">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="number" path="runescapeId" class="form-control" placeholder="Runescape ID"
                ...
                <spring:bind path="experience">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="number" step="any" path="experience" class="form-control"
                                    placeholder="Experience each" required="required"></form:input>
                ...
                <spring:bind path="levelNeeded">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="number" path="levelNeeded" class="form-control" placeholder="Level needed"
                ...
                <spring:bind path="skill">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="text" path="skill" class="form-control" placeholder="Skill"
                                    required="required"></form:input>
